      ...
      <Row className='text-center'>
          <Col>
            <div className="container">
              <a href='/news-blog/page/7' className='m-3'><button type='button'> &#x2039; </button></a>
              <a href='/news-blog' className='m-3'><button type='button'>1</button></a>
              ...
              <a href='/news-blog/page/7' className='m-3'><button type='button'>7</button></a>
              <a href='/news-blog/page/8' className='m-3'><button type='button' style={{ backgroundColor: '#000000', color: '#ffffff' }}>8</button></a>
              <a href='/news-blog/page/9' className='m-3'><button type='button'>9</button></a>
              ...
              <a href='/news-blog/page/11' className='m-3'><button type='button'>11</button></a>
              <a href='/news-blog/page/9' className='m-3'><button type='button'> &#x203A;</button></a>
            </div>
          </Col>
        </Row>
    </div>
