...
import image from '../../component/img/Blog/representations-user-experience--scaled-thegem-blog-masonry.jpg';
...
function ImportanceOfSecurty() {
  let a = "<a className='color-bule'> mobile app developer services</a>";
  const Data = {
    Content1 : {
...
export default ImportanceOfSecurty;